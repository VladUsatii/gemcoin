...
def parse(hexadecimal):
	...
	valueParser = {DerFieldType.null: _parseNull, DerFieldType.object: _parseOid, DerFieldType.utcTime: _parseTime, DerFieldType.integer: _parseInteger, DerFieldType.printableString: _parseString}.get(tagData["type"], _parseAny)
...
def _getTagData(tag):
	...
	return {"class": tagClass, "isConstructed": isConstructed, "type": _hexTagToType.get(tag)}

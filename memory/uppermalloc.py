...
def ephemeralProcess() -> list:
	...
	if userConfig[2] == False:
		#GENESIS_TRANSACTION = list({0: ConstructTransaction(20, 0, 1644394160, "0x77dca013986bdfcee6033cac4a0b12b494171b61", "0x77dca013986bdfcee6033cac4a0b12b494171b61", 60000000000000000000000000, '0x00000000000000000000000000000000')})
		GENESIS_TRANSACTION = []
		tx = json.dumps(ConstructTransaction(20, 0, 1644394160, '0x77dca013986bdfcee6033cac4a0b12b494171b61', '0x77dca013986bdfcee6033cac4a0b12b494171b61', 60000000000000000000000000, '0x00000000000000000000000000000000'))
		GENESIS_TRANSACTION.append(tx)
		# NEWW #GENESIS_TRANSACTION = [json.dumps(ConstructTransaction(20, 0, 1644394160, '0x77dca013986bdfcee6033cac4a0b12b494171b61', '0x77dca013986bdfcee6033cac4a0b12b494171b61', 60000000000000000000000000, '0x00000000000000000000000000000000'))]
